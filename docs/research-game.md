...
- The Orbitals layer renders one selected σ, π or lone-pair mode. A 70/30 split places a complete MO energy diagram to the right of the molecule; levels are clickable, degenerate levels align horizontally, and groups of five or more collapse behind an expandable ellipsis. Signed coefficients control phase, lobe size and nodes. The general electron-cloud layer remains a qualitative domain display rather than a quantum density isosurface.
