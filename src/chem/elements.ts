...
const genericPeoe = (a: number) => ({
  "*": { a, b: Math.max(4, a * 0.7), c: 0 },
});
...
export const ELEMENTS: Record<ElementSymbol, ElementInfo> = {
  ...
  Li: seed("Li", {
    ...
    period: 2,
    name: "Liberium",
    nameRoot: "liber: readily releases its outer electron",
    valence: 1,
    allowedValences: [1],
    valenceElectrons: 1,
    ...
    displayColor: 0xcc80ff,
    peoe: genericPeoe(3.0),
    huckelCoulomb: 1.2,
  }),
  B: seed("B", {
    atomicNumber: 5,
  ...
  Mg: seed("Mg", {
    ...
    period: 3,
    name: "Mergium",
    nameRoot: "merge: couples an organic group to a metal center",
    valence: 2,
    allowedValences: [2],
    valenceElectrons: 2,
    electronConfiguration: "[Ne] 3s2",
    lonePairs: 0,
    electronegativity: 3.3,
    covalentRadius: 1.41,
    vanDerWaalsRadius: 1.73,
    displayColor: 0x8aff00,
    peoe: {
      sp3: { a: 3.3, b: 5.587, c: 2.447 },
      sp2: { a: 3.565, b: 5.572, c: 2.197 },
      sp: { a: 4.04, b: 5.472, c: 1.823 },
    },
    huckelCoulomb: 1.0,
  }),
  P: seed("P", {
    ...
    period: 3,
    name: "Pivotium",
    nameRoot: "pivot: supports three- and five-coordinate branching",
    valence: 3,
    allowedValences: [3, 5],
    valenceElectrons: 5,
    electronConfiguration: "[Ne] 3s2 3p3",
    lonePairs: 1,
    electronegativity: 8.9,
    covalentRadius: 1.07,
    vanDerWaalsRadius: 1.8,
    displayColor: 0xff8000,
    peoe: {
      sp3: { a: 8.9, b: 8.24, c: 0.96 },
      sp2: { a: 9.665, b: 8.53, c: 0.735 },
    },
    huckelCoulomb: -0.2,
  }),
  S: seed("S", {
    ...
    period: 3,
    name: "Sociatium",
    nameRoot: "sociate: forms many bonding arrangements",
    valence: 2,
    allowedValences: [2, 4, 6],
    valenceElectrons: 6,
    electronConfiguration: "[Ne] 3s2 3p4",
    lonePairs: 2,
    electronegativity: 10.14,
    covalentRadius: 1.05,
    vanDerWaalsRadius: 1.8,
    displayColor: 0xffd123,
    peoe: {
      sp3: { a: 10.14, b: 9.13, c: 1.38 },
      sp2: { a: 10.88, b: 9.49, c: 1.33 },
    },
    huckelCoulomb: -0.45,
  }),
  Cl: seed("Cl", {
